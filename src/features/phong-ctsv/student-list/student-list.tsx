            ...
            <div className='p-4 md:p-8 bg-white shadow-2xl rounded-xl'>
                ...
                <div className='grid grid-cols-2 md:grid-cols-7 gap-3 mb-8 items-end p-4 bg-gray-50 rounded-xl border border-gray-200'>
                    ...
                    <div className='relative'>
                        ...
                        />
                        <Calendar size={18} className='absolute right-2 top-7 text-gray-400 pointer-events-none'/>
                    </div>
...
//   // unique lists
//   const uniqueFaculties = useMemo(() => [...new Set(tutorDataa.map(x => x.faculty))], []);
//   const uniqueTutors = useMemo(() => [...new Set(tutorDataa.map(x => x.tutor))], []);

//   const topicsOfSelectedFaculty = useMemo(() => {
//     if (!selectedFaculty) return [];
//     return FACULTY_TOPIC_MAP[selectedFaculty] || [];
//   }, [selectedFaculty]);

//   const applyFilter = useCallback(() => {
//     const result = tutorDataa.filter(item => {
//       const facultyOk = selectedFaculty === '' || item.faculty === selectedFaculty;
//       const topicOk = selectedTopic === '' || item.topic === selectedTopic;
//       const tutorOk = selectedTutor === '' || item.tutor === selectedTutor;
//       return facultyOk && topicOk && tutorOk;
//     });
//     setFilteredData(result);
//   }, [selectedFaculty, selectedTopic, selectedTutor]);
...
//   const columns: Column<StudentRow>[] = useMemo(() => [
//     { header: 'Student ID', accessor: 'stuId', width: '10%' },
//     { header: 'Name', accessor: 'name', width: '25%' },
//     { header: 'Faculty', accessor: 'faculty', width: '25%' },
//     { header: 'Topic', accessor: 'topic', width: '20%' },
//     {
//       header: 'Tutor',
//       accessor: 'tutor',
//       width: '20%',
//       render: (row) => (
//         <span className='text-indigo-700 font-semibold'>{row.tutor}</span>
//       )
//     }
//   ], []);
...
//           {/* Faculty */}
//           <div>
//             <label className="text-xs text-gray-600 font-medium">Faculty</label>
//             <select
//               value={selectedFaculty}
//               onChange={e => {
...
//                 setSelectedTopic('')
//               }}
//               className='w-full px-3 py-2 border rounded-lg bg-white shadow-sm text-sm'
//             >
...
//           {/* Topic */}
//           <div>
//             <label className="text-xs text-gray-600 font-medium">Topic</label>
//             <select
//               value={selectedTopic}
...
//             >
//               <option value=''>--- All ---</option>
//               {topicsOfSelectedFaculty.map((t, i) => (
...
//           {/* Tutor */}
//           <div>
//             <label className="text-xs text-gray-600 font-medium">Tutor</label>
//             <select
//               value={selectedTutor}
...
//             <button
//               onClick={applyFilter}
//               className='flex items-center justify-center gap-2 w-full bg-indigo-600 text-white px-4 py-2 rounded-lg shadow-md hover:bg-indigo-700'
//             >
//               <Search size={18} />
//               Search
//             </button>
...
//           <div className='flex items-end'>
//             <button
//               onClick={() => console.log("Export student list...")}
//               className='flex items-center justify-center gap-2 w-full bg-green-600 text-white px-4 py-2 rounded-lg shadow-md hover:bg-green-700'
//             >
//               <List size={18} />
//               Export
//             </button>
...
//           <Filter size={20} className="text-indigo-500" />
//           Student List ({filteredData.length})
//         </div>
