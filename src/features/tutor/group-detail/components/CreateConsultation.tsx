...
const CreateConsultationModal: React.FC<NewConsul> = ({ onBack }) => {
  ...
  const handleSaveConsul = () => {
    const sortedTime = [...formData.time].sort((a, b) => parseInt(a) - parseInt(b))
    const finalData = { ...formData, time: sortedTime }

    console.log('formData changed:', finalData)
    //GỌI API lưu buổi tư vấn mới
    document.body.style.pointerEvents = 'auto'
    onBack?.()
  }
        ...
        <div className='p-6'>
          ...
          <div className='flex justify-end gap-3 pt-6 mt-6 border-t border-gray-200'>
            <button
              ...
              className='flex items-center gap-2 px-4 py-2 text-gray-700 bg-gray-200 rounded-md hover:bg-gray-400 transition font-medium'
            >
              <RxCrossCircled />
              Cancel
            </button>
            ...
            <button
              ...
              className='flex items-center gap-2 px-5 py-2 text-white bg-blue-600 rounded-md hover:bg-blue-900 transition font-medium'
            >
              <SiTicktick />
              Save
            </button>
